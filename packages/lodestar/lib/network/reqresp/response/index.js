...
async function handleRequest({ config, logger, libp2p }, performRequestHandler, stream, peerId, protocol, signal, requestId = 0) {
    ...
    (async function* requestHandlerSource() {
        try {
            ...
            logger.debug("Resp received request", { ...logCtx, requestBody });
            ...
            (0, utils_1.onChunk)(() => logger.debug("Resp sending chunk", logCtx)), (0, responseEncode_1.responseEncodeSuccess)(config, protocol));
        }
        catch (e) {
