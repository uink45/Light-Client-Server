...
exports.createProcessRpcMessageQueues = void 0;
...
const gossipQueueOpts = {
    ...
    [interface_1.GossipType.beacon_aggregate_and_proof]: { maxLength: 4096, type: queue_1.QueueType.LIFO, maxConcurrency: 16 },
    [interface_1.GossipType.beacon_attestation]: { maxLength: 16384, type: queue_1.QueueType.LIFO, maxConcurrency: 64 },
 ...
 */
function createProcessRpcMessageQueues(processRpcMsgFn, signal, metrics) {
    return (0, lodestar_utils_1.mapValues)(gossipQueueOpts, (opts, type) => {
        return new queue_1.JobItemQueue((topic, message) => processRpcMsgFn(message), { signal, ...opts }, metrics
            ? {
...
exports.createProcessRpcMessageQueues = createProcessRpcMessageQueues;
