...
class Eth2Gossipsub extends libp2p_gossipsub_1.default {
    constructor(modules) {
        ...
        this.validatorFnsByType = (0, validation_1.createValidatorFnsByType)(gossipHandlers, {
            config,
            logger,
        ...
        const { processRpcMessagesFnByType, jobQueues } = (0, validation_1.createProcessRpcMessageFnsByType)(super._processRpcMessage.bind(this), signal, metrics);
