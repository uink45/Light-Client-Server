...
export declare type ProcessRpcMessageTopicFn = (topic: GossipTopic, message: InMessage) => Promise<void>;
export declare type ProcessRpcMessageFn = (message: InMessage) => Promise<void>;
export declare type ProcessRpcMessageFnsByType = {
    [K in GossipType]: ProcessRpcMessageTopicFn;
};
export declare type GossipJobQueues = {
    [K in GossipType]: JobItemQueue<[GossipTopic, InMessage], void>;
};
