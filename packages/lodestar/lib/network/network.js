    ...
    constructor(opts, modules) {
        ...
        this.onEpoch = (epoch) => {
            try {
                ...
                const forks = (0, forks_1.getCurrentAndNextFork)(this.config, epoch - forks_1.FORK_EPOCH_LOOKAHEAD - 1);
        ...
        this.gossip = new gossip_1.Eth2Gossipsub({
            ...
            metrics,
            signal,
            gossipHandlers: gossipHandlers !== null && gossipHandlers !== void 0 ? gossipHandlers : (0, gossip_1.getGossipHandlers)({ chain, config, logger, network: this, metrics }),
            eth2Context: {
