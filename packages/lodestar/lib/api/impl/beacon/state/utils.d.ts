 ...
 */
export declare function getEpochBeaconCommittees(state: allForks.BeaconState | CachedBeaconState<allForks.BeaconState>, epoch: Epoch): ValidatorIndex[][][];
/**
 * Returns committees as an array of validator index
 */
export declare function getSyncCommittees(state: allForks.BeaconState | CachedBeaconState<allForks.BeaconState>, epoch: Epoch): ValidatorIndex[];
export declare function filterStateValidatorsByStatuses(statuses: string[], state: allForks.BeaconState, pubkey2index: allForks.PubkeyIndexMap, currentEpoch: Epoch): routes.beacon.ValidatorResponse[];
export declare function getStateValidatorIndex(id: routes.beacon.ValidatorId | ByteVector, state: allForks.BeaconState, pubkey2index: allForks.PubkeyIndexMap): number | undefined;
export {};
