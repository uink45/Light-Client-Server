...
exports.getPubkeysForIndex = exports.getPubkeysForIndices = exports.computeSubnetForCommitteesAtSlot = exports.getSyncComitteeValidatorIndexMap = void 0;
const lodestar_beacon_state_transition_1 = require("@chainsafe/lodestar-beacon-state-transition");
const lodestar_params_1 = require("@chainsafe/lodestar-params");
const lodestar_types_1 = require("@chainsafe/lodestar-types");
const errors_1 = require("../errors");
function getSyncComitteeValidatorIndexMap(config, state, requestedEpoch) {
    const statePeriod = (0, lodestar_beacon_state_transition_1.computeSyncPeriodAtEpoch)(config, (0, lodestar_beacon_state_transition_1.computeEpochAtSlot)(state.slot));
    const requestPeriod = (0, lodestar_beacon_state_transition_1.computeSyncPeriodAtEpoch)(config, requestedEpoch);
    if (state.epochCtx !== undefined) {
        switch (requestPeriod) {
            case statePeriod:
                return state.currentSyncCommittee.validatorIndexMap;
            case statePeriod + 1:
                return state.nextSyncCommittee.validatorIndexMap;
            default:
...
exports.getSyncComitteeValidatorIndexMap = getSyncComitteeValidatorIndexMap;
