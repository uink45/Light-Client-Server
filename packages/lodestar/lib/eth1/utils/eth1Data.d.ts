 ...
 */
export declare function getEth1DataForBlocks(blocks: phase0.Eth1Block[], depositDescendingStream: AsyncIterable<phase0.DepositEvent>, depositRootTree: TreeBacked<List<Root>>, lastProcessedDepositBlockNumber: BlockNumber | null): Promise<(phase0.Eth1Data & phase0.Eth1Block)[]>;
/**
