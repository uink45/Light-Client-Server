...
class Eth1DepositDataTracker {
    constructor(opts, { config, db, logger, signal }, eth1Provider) {
        ...
        this.logger = logger;
        this.eth1Provider = eth1Provider;
        this.depositsCache = new eth1DepositsCache_1.Eth1DepositsCache(config, db);
    ...
    async getDeposits(state, eth1DataVote) {
        ...
        const newEth1Data = lodestar_beacon_state_transition_1.allForks.getNewEth1Data(state, eth1DataVote) || state.eth1Data;
