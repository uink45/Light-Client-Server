...
export declare function verifyBlockProposerSignature(bls: IBlsVerifier, state: CachedBeaconState<allForks.BeaconState>, blocks: allForkTypes.SignedBeaconBlock[]): Promise<void>;
