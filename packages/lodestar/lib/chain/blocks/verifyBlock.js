        ...
        switch (execResult.status) {
            ...
            case interface_1.ExecutePayloadStatus.INVALID: {
                ...
                throw new errors_1.BlockError(block, {
                    code: errors_1.BlockErrorCode.EXECUTION_PAYLOAD_NOT_VALID,
            ...
            case interface_1.ExecutePayloadStatus.SYNCING: {
                ...
                if (justifiedBlock.executionStatus === lodestar_fork_choice_1.ExecutionStatus.PreMerge &&
                    block.message.slot + lodestar_params_1.SAFE_SLOTS_TO_IMPORT_OPTIMISTICALLY > clockSlot) {
                    throw new errors_1.BlockError(block, {
                        code: errors_1.BlockErrorCode.EXECUTION_ENGINE_ERROR,
                        errorMessage: `not safe to import SYNCING payload within ${lodestar_params_1.SAFE_SLOTS_TO_IMPORT_OPTIMISTICALLY} of currentSlot`,
                    });
                }
