...
export declare function onCheckpoint(this: BeaconChain, cp: phase0.Checkpoint, state: CachedBeaconState<allForks.BeaconState>): void;
export declare function onJustified(this: BeaconChain, cp: phase0.Checkpoint, state: CachedBeaconState<allForks.BeaconState>): void;
...
export declare function onBlock(this: BeaconChain, block: allForks.SignedBeaconBlock, _postState: CachedBeaconState<allForks.BeaconState>): Promise<void>;
