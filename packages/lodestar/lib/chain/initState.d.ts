 ...
 */
export declare function restoreStateCaches(config: IBeaconConfig, stateCache: StateContextCache, checkpointStateCache: CheckpointStateCache, state: TreeBacked<allForks.BeaconState>): CachedBeaconState<allForks.BeaconState>;
