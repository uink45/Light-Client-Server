 ...
 */
export declare function getLatestWeakSubjectivityCheckpointEpoch(config: IChainForkConfig, state: CachedBeaconState<allForks.BeaconState>): Epoch;
/**
 ...
 */
export declare function computeWeakSubjectivityPeriodCachedState(config: IChainForkConfig, state: CachedBeaconState<allForks.BeaconState>): number;
/**
