 ...
 * Spec v1.0.1
 */
export declare const ExecutionPayload: ContainerType<merge.ExecutionPayload>;
/**
 * ```python
 * class ExecutionPayload(Container):
 *     ...
 ...
 * Spec v1.0.1
 */
export declare const ExecutionPayloadHeader: ContainerType<merge.ExecutionPayloadHeader>;
export declare const BeaconBlockBody: ContainerType<merge.BeaconBlockBody>;
export declare const BeaconBlock: ContainerType<merge.BeaconBlock>;
export declare const SignedBeaconBlock: ContainerType<merge.SignedBeaconBlock>;
export declare const PowBlock: ContainerType<merge.PowBlock>;
...
export declare const BeaconState: ContainerType<merge.BeaconState>;
