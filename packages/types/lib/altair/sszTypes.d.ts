...
export declare const LightClientSnapshot: ContainerType<altair.LightClientSnapshot>;
export declare const LightClientUpdate: ContainerType<altair.LightClientUpdate>;
export declare const LightClientStore: ContainerType<altair.LightClientStore>;
