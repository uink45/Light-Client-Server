...
exports.chainConfig = {
    ...
    PRESET_BASE: lodestar_params_1.PresetName.minimal,
    // Transition
    ...
    GENESIS_FORK_VERSION: (0, ssz_1.fromHexString)("0x00000001"),
    ...
    // Altair
    ALTAIR_FORK_VERSION: (0, ssz_1.fromHexString)("0x01000001"),
    ALTAIR_FORK_EPOCH: 74240,
    // Merge
    MERGE_FORK_VERSION: (0, ssz_1.fromHexString)("0x02000001"),
    MERGE_FORK_EPOCH: Infinity,
    // Sharding
    SHARDING_FORK_VERSION: (0, ssz_1.fromHexString)("0x03000001"),
    ...
    DEPOSIT_CONTRACT_ADDRESS: (0, ssz_1.fromHexString)("0x1234567890123456789012345678901234567890"),
};
