...
class ValidatorDir {
    ...
    constructor(baseDir, pubkey, options) {
        this.dir = path_1.default.join(baseDir, (0, format_1.add0xPrefix)(pubkey));
        this.lockfilePath = path_1.default.join(this.dir, paths_1.LOCK_FILE);
    ...
    async votingKeypair(secretsDir) {
        const keystorePath = path_1.default.join(this.dir, paths_1.VOTING_KEYSTORE_FILE);
    ...
    async withdrawalKeypair(secretsDir) {
        const keystorePath = path_1.default.join(this.dir, paths_1.WITHDRAWAL_KEYSTORE_FILE);
        return await this.unlockKeypair(keystorePath, secretsDir);
    }
    /**
    ...
    async unlockKeypair(keystorePath, secretsDir) {
        const keystore = bls_keystore_1.Keystore.parse(fs_1.default.readFileSync(keystorePath, "utf8"));
    ...
    eth1DepositTxHashExists() {
        return fs_1.default.existsSync(path_1.default.join(this.dir, paths_1.ETH1_DEPOSIT_TX_HASH_FILE));
    }
    /**
     * Saves the `tx_hash` to a file in `this.dir`.
     */
    saveEth1DepositTxHash(txHash) {
        const filepath = path_1.default.join(this.dir, paths_1.ETH1_DEPOSIT_TX_HASH_FILE);
        if (fs_1.default.existsSync(filepath))
            throw new util_1.YargsError(`ETH1_DEPOSIT_TX_HASH_FILE ${filepath} already exists`);
        fs_1.default.writeFileSync(filepath, txHash);
    }
    /**
     ...
     */
    eth1DepositData() {
        const depositDataPath = path_1.default.join(this.dir, paths_1.ETH1_DEPOSIT_DATA_FILE);
        const depositAmountPath = path_1.default.join(this.dir, paths_1.ETH1_DEPOSIT_AMOUNT_FILE);
        const depositDataRlp = fs_1.default.readFileSync(depositDataPath, "utf8");
        const depositAmount = fs_1.default.readFileSync(depositAmountPath, "utf8");
