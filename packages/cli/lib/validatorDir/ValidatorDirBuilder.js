...
class ValidatorDirBuilder {
    ...
    async build({ keystores, passwords, storeWithdrawalKeystore, depositGwei, config, }) {
        ...
        if (fs_1.default.existsSync(dir) || fs_1.default.existsSync((0, paths_1.getValidatorDirPath)({ keystoresDir, pubkey }))) {
        ...
        fs_1.default.writeFileSync(path_1.default.join(dir, paths_1.ETH1_DEPOSIT_DATA_FILE), depositDataRlp);
        // Save `ETH1_DEPOSIT_AMOUNT_FILE` to file.
        // This allows us to know the intended deposit amount at a later date.
        fs_1.default.writeFileSync(path_1.default.join(dir, paths_1.ETH1_DEPOSIT_AMOUNT_FILE), depositGwei.toString());
        // Only the withdrawal keystore if explicitly required.
        if (storeWithdrawalKeystore) {
            fs_1.default.writeFileSync(path_1.default.join(dir, paths_1.WITHDRAWAL_KEYSTORE_FILE), keystores.withdrawal.stringify());
        ...
        fs_1.default.writeFileSync(path_1.default.join(dir, paths_1.VOTING_KEYSTORE_FILE), keystores.signing.stringify());
