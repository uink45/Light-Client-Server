...
function getValidatorDirPath({ keystoresDir, pubkey, prefixed, }) {
    return path_1.default.join(keystoresDir, prefixed ? (0, format_1.add0xPrefix)(pubkey) : pubkey);
}
exports.getValidatorDirPath = getValidatorDirPath;
function getValidatorPassphrasePath({ secretsDir, pubkey, prefixed, }) {
    return path_1.default.join(secretsDir, prefixed ? (0, format_1.add0xPrefix)(pubkey) : pubkey);
}
