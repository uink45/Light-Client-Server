...
function parseBeaconParamsArgs(args) {
    return (0, util_1.ObjectKeys)(lodestar_config_1.ChainConfig.fields).reduce((beaconParams, key) => {
...
const paramsOptionsByName = (0, util_1.ObjectKeys)(lodestar_config_1.ChainConfig.fields).reduce((options, key) => ({
    ...options,
    [getArgKey(key)]: {
        hidden: true,
        type: "string",
