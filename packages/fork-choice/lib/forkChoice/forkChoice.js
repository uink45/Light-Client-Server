...
class ForkChoice {
    ...
    updateHead() {
        ...
        try {
            if (!this.synced) {
                ...
                const deltas = (0, computeDeltas_1.computeDeltas)(this.protoArray.indices, this.votes, this.justifiedBalances, this.justifiedBalances);
            ...
            (_c = this.metrics) === null || _c === void 0 ? void 0 : _c.forkChoiceErrors.inc();
            throw e;
        }
        finally {
            if (timer)
    ...
    onBlock(block, state, preCachedData) {
        ...
        if ((preCachedData === null || preCachedData === void 0 ? void 0 : preCachedData.isMergeBlock) ||
            (lodestar_beacon_state_transition_1.merge.isMergeStateType(state) && lodestar_beacon_state_transition_1.merge.isMergeBlockBodyType(block.body) && lodestar_beacon_state_transition_1.merge.isMergeBlock(state, block.body)))
        ...
        if (finalizedCheckpoint.epoch > this.fcStore.finalizedCheckpoint.epoch) {
            ...
            (!(0, store_1.equalCheckpointWithHex)(this.fcStore.justifiedCheckpoint, currentJustifiedCheckpoint) &&
                stateJustifiedEpoch > this.fcStore.justifiedCheckpoint.epoch) ||
                this.getAncestor(this.fcStore.justifiedCheckpoint.rootHex, (0, lodestar_beacon_state_transition_1.computeStartSlotAtEpoch)(this.fcStore.finalizedCheckpoint.epoch)) !== this.fcStore.finalizedCheckpoint.rootHex) {
                shouldUpdateJustified = true;
            }
        }
        ...
        this.protoArray.onBlock({
            ...
            ...(lodestar_beacon_state_transition_1.merge.isMergeBlockBodyType(block.body) &&
                lodestar_beacon_state_transition_1.merge.isMergeStateType(state) &&
                lodestar_beacon_state_transition_1.merge.isExecutionEnabled(state, block.body)
                ? {
     ...
     */
    validateOnAttestation(indexedAttestation) {
        ...
        const beaconBlockRootHex = (0, ssz_1.toHexString)(beaconBlockRoot);
        const { epoch: targetEpoch, root: targetRoot } = target;
        const targetRootHex = (0, ssz_1.toHexString)(targetRoot);
        ...
        if (this.fcStore.currentSlot < slot + 1) {
            throw new errors_1.ForkChoiceError({
                code: errors_1.ForkChoiceErrorCode.INVALID_ATTESTATION,
                err: {
                    code: errors_1.InvalidAttestationCode.FUTURE_SLOT,
        ...
        if (!this.protoArray.hasBlock(targetRootHex)) {
            throw new errors_1.ForkChoiceError({
                ...
                err: {
                    ...
                    root: (0, ssz_1.toHexString)(targetRoot),
                },
            });
        }
        ...
        if (!block) {
            throw new errors_1.ForkChoiceError({
                ...
                err: {
                    ...
                    beaconBlockRoot: (0, ssz_1.toHexString)(beaconBlockRoot),
                },
            });
        }
        ...
        const expectedTargetHex = target.epoch > (0, lodestar_beacon_state_transition_1.computeEpochAtSlot)(block.slot) ? beaconBlockRootHex : block.targetRoot;
        if (expectedTargetHex !== targetRootHex) {
            throw new errors_1.ForkChoiceError({
                code: errors_1.ForkChoiceErrorCode.INVALID_ATTESTATION,
                err: {
                    code: errors_1.InvalidAttestationCode.INVALID_TARGET,
                    attestation: (0, ssz_1.toHexString)(targetRoot),
