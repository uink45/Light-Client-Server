...
class ForkChoice {
    ...
    onBlock(block, state, preCachedData) {
        ...
        if (lodestar_beacon_state_transition_1.merge.isMergeStateType(state) &&
            lodestar_beacon_state_transition_1.merge.isMergeBlockBodyType(block.body) &&
            lodestar_beacon_state_transition_1.merge.isMergeBlock(state, block.body))
        ...
        this.protoArray.onBlock({
            ...
            executionPayloadBlockHash: lodestar_beacon_state_transition_1.merge.isMergeBlockBodyType(block.body)
                ? (0, ssz_1.toHexString)(block.body.executionPayload.blockHash)
                : null,
