...
exports.isValidAttestationData = exports.intersection = exports.extractParticipation = exports.aggregateInto = exports.MatchingDataAttestationGroup = exports.AggregatedAttestationPool = void 0;
    ...
    getParticipationAltair(state) {
        ...
        return (epoch, committee) => {
            ...
            for (const validatorIndex of committee) {
                if ((_a = participationStatus[validatorIndex]) === null || _a === void 0 ? void 0 : _a.timelySource) {
...
function aggregateInto(attestation1, attestation2, committee) {
    for (const attIndex of attestation2.attestingIndices) {
        attestation1.attestingIndices.add(attIndex);
    }
    attestation1.attestation.aggregationBits = Array.from({ length: committee.length }, (_, i) => attestation1.attestingIndices.has(committee[i]));
...
function extractParticipation(attestations, epochCtx) {
