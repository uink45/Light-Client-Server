...
exports.SyncChain = exports.SyncChainStatus = exports.SyncChainStartError = void 0;
...
class SyncChain {
    ...
    async sync() {
        try {
            ...
            if (e instanceof batch_1.BatchError && e.type.code === batch_1.BatchErrorCode.MAX_PROCESSING_ATTEMPTS) {
                for (const peer of this.peerset.keys()) {
                    this.reportPeer(peer, network_1.PeerAction.LowToleranceError, "SyncChainMaxProcessingAttempts");
                }
            }
