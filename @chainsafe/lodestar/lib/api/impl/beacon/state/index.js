...
function getBeaconStateApi({ chain, config, db }) {
    ...
    return {
        ...
        async getEpochCommittees(stateId, filters) {
            var _a;
            const state = await (0, utils_1.resolveStateId)(config, chain, db, stateId);
            const committes = (0, utils_1.getEpochBeaconCommittees)(state, (_a = filters === null || filters === void 0 ? void 0 : filters.epoch) !== null && _a !== void 0 ? _a : (0, lodestar_beacon_state_transition_1.computeEpochAtSlot)(state.slot));
