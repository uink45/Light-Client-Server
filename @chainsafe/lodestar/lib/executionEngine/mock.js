...
class ExecutionEngineMock {
    ...
    async executePayload(executionPayload) {
        ...
        if (!this.knownBlocks.has((0, ssz_1.toHexString)(executionPayload.parentHash))) {
            return interface_1.ExecutePayloadStatus.INVALID;
        }
        this.knownBlocks.set((0, ssz_1.toHexString)(executionPayload.blockHash), executionPayload);
        return interface_1.ExecutePayloadStatus.VALID;
    }
    /**
    ...
    async notifyForkchoiceUpdate(headBlockHash, finalizedBlockHash, payloadAttributes) {
        ...
        const payload = {
            ...
            stateRoot: crypto_1.default.randomBytes(32),
            receiptsRoot: crypto_1.default.randomBytes(32),
            logsBloom: crypto_1.default.randomBytes(lodestar_params_1.BYTES_PER_LOGS_BLOOM),
            ...
            extraData: constants_1.ZERO_HASH,
            baseFeePerGas: BigInt(0),
            blockHash: crypto_1.default.randomBytes(32),
            transactions: [crypto_1.default.randomBytes(512)],
        };
