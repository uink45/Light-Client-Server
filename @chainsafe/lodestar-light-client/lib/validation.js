...
exports.assertValidSignedHeader = exports.assertValidSyncCommitteeProof = exports.assertValidFinalityProof = exports.assertValidLightClientUpdate = void 0;
...
function assertValidLightClientUpdate(config, syncCommittee, update) {
    ...
    const isFinalized = !(0, utils_1.isEmptyHeader)(update.finalityHeader);
    ...
    const headerBlockRoot = lodestar_types_1.ssz.phase0.BeaconBlockHeader.hashTreeRoot(signedHeader);
...
function assertValidFinalityProof(update) {
    if (!(0, verifyMerkleBranch_1.isValidMerkleBranch)(lodestar_types_1.ssz.phase0.BeaconBlockHeader.hashTreeRoot(update.header), Array.from(update.finalityBranch).map((i) => i.valueOf()), lodestar_params_1.FINALIZED_ROOT_DEPTH, lodestar_params_1.FINALIZED_ROOT_INDEX, update.finalityHeader.stateRoot.valueOf())) {
        throw Error("Invalid finality header merkle branch");
    }
    const updatePeriod = (0, clock_1.computeAbsoluteSyncPeriodAtSlot)(update.header.slot);
    const updateFinalityPeriod = (0, clock_1.computeAbsoluteSyncPeriodAtSlot)(update.finalityHeader.slot);
