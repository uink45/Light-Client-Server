...
class WalletManager {
    ...
    wallets() {
        return fs_1.default
            ...
            .filter((file) => (0, uuidv4_1.isUuid)(file) && fs_1.default.statSync(path_1.default.join(this.walletsDir, file)).isDirectory())
            .map((walletUuid) => {
            const walletInfoPath = path_1.default.join(this.walletsDir, walletUuid, walletUuid);
            const walletInfo = JSON.parse(fs_1.default.readFileSync(walletInfoPath, "utf8"));
    ...
    writeWallet(wallet) {
        ...
        const walletInfoPath = path_1.default.join(this.walletsDir, wallet.uuid, wallet.uuid);
        fs_1.default.writeFileSync(walletInfoPath, wallet.toWalletJSON());
    }
    /**
    ...
    async createWallet(name, walletType, mnemonic, password) {
        ...
        const walletDir = path_1.default.join(this.walletsDir, wallet.uuid);
