 ...
 */
exports.gitDataPath = path_1.default.resolve(__dirname, "../../../.git-data.json");
/** Writes a persistent git data file. */
function writeGitDataFile(gitData) {
    fs_1.default.writeFileSync(exports.gitDataPath, JSON.stringify(gitData, null, 2));
}
exports.writeGitDataFile = writeGitDataFile;
/** Reads the persistent git data file. */
function readGitDataFile() {
    return JSON.parse(fs_1.default.readFileSync(exports.gitDataPath, "utf8"));
}
