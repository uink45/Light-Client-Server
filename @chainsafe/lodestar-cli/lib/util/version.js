...
function readVersionFromLernaJson() {
    ...
    if (!filePath)
        return undefined;
    const lernaJson = JSON.parse(fs_1.default.readFileSync(filePath, "utf8"));
...
function readCliPackageJson() {
    ...
    if (!filePath)
        return undefined;
    const packageJson = JSON.parse(fs_1.default.readFileSync(filePath, "utf8"));
