...
function readPassphraseFile(passphraseFile) {
    const data = fs_1.default.readFileSync(passphraseFile, "utf8");
...
function readValidatorPassphrase({ secretsDir, pubkey }) {
    ...
    if (fs_1.default.existsSync(notPrefixedPath)) {
...
function writeValidatorPassphrase({ secretsDir, pubkey, passphrase, }) {
    (0, fs_2.writeFile600Perm)((0, paths_1.getValidatorPassphrasePath)({ secretsDir, pubkey, prefixed: true }), passphrase);
}
