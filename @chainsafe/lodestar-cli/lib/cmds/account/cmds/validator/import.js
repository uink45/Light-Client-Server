...
has the '.json' extension will be attempted to be imported.",
  ...
  - UUID: ${uuid}`);
            ...
            fs_1.default.writeFileSync(path_1.default.join(dir, paths_1.VOTING_KEYSTORE_FILE), keystore.stringify());
 ...
 */
async function getKeystorePassphrase(keystore, passphrasePaths) {
    ...
    if (passphraseFile) {
        const passphrase = fs_1.default.readFileSync(passphraseFile, "utf8");
        try {
