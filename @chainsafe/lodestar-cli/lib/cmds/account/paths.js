...
function getAccountPaths(args) {
    ...
    const keystoresDir = args.keystoresDir || path_1.default.join(rootDir, "keystores");
    const secretsDir = args.secretsDir || path_1.default.join(rootDir, "secrets");
    const walletsDir = args.walletsDir || path_1.default.join(rootDir, "wallets");
    return {
        ...globalPaths,
        keystoresDir,
        secretsDir,
