...
exports.processSlots = exports.processBlock = exports.stateTransition = void 0;
...
const processBlockByFork = {
    ...
    [lodestar_params_1.ForkName.merge]: merge.processBlock,
};
const processEpochByFork = {
    ...
    [lodestar_params_1.ForkName.merge]: altair.processEpoch,
};
...
function processSlotsWithTransientCache(postState, slot, metrics) {
    ...
    while (postState.slot < slot) {
        ...
        if ((postState.slot + 1) % lodestar_params_1.SLOTS_PER_EPOCH === 0) {
            ...
            try {
                const epochProcess = (0, util_1.beforeProcessEpoch)(postState);
                ...
                postState.slot++;
                (0, util_1.afterProcessEpoch)(postState, epochProcess);
            }
            finally {
                if (timer)
                    timer();
