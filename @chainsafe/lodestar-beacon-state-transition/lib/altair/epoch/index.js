...
exports.processEpoch = exports.processParticipationFlagUpdates = exports.processSyncCommitteeUpdates = exports.processSlashings = exports.processRewardsAndPenalties = exports.processInactivityUpdates = exports.getRewardsPenaltiesDeltas = void 0;
...
Object.defineProperty(exports, "getRewardsPenaltiesDeltas", { enumerable: true, get: function () { return balance_1.getRewardsPenaltiesDeltas; } });
function processEpoch(state, epochProcess) {
    ...
    (0, processSyncCommitteeUpdates_1.processSyncCommitteeUpdates)(state, epochProcess);
}
