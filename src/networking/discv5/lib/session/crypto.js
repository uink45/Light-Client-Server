...
function generateSessionKeys(localId, remoteContact, challengeData) {
    const remoteKeypair = nodeInfo_1.getPublicKey(remoteContact);
    ...
    */
    return [...deriveKey(secret, localId, nodeInfo_1.getNodeId(remoteContact), challengeData), ephemKeypair.publicKey];
}
